...
[task_local]
#进店领豆3
10 0 * * * jd_shop.js, tag=进店领豆4, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_shop.png, enabled=true
================Loon============
[Script]
cron "10 0 * * *" script-path=jd_shop.js,tag=进店领豆5
==============Surge===============
[Script]
进店领豆6 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=3600,script-path=jd_shop.js
*/
const $ = new Env('进店领豆7');
